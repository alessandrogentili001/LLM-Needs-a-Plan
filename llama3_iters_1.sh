...
#SBATCH --mem=64G
#SBATCH --job-name=llama3_iters_1
#SBATCH --output=llama3_iters_1.out
#SBATCH --error=llama3_iters_1.err
...
# Model configuration
MODEL_NAME="llama3"
WEIGHTS_PATH="src/models/Llama3"  # weights directory for the chosen model
...
LOG_LEVEL="INFO"
LOG_FILE=""  # set to e.g. "logs/llama3_iters_1.log" to persist logs
