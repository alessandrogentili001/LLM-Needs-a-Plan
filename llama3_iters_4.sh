...
#SBATCH --mem=64G
#SBATCH --job-name=llama3_iters_4
#SBATCH --output=llama3_iters_4.out
#SBATCH --error=llama3_iters_4.err
...
LOG_LEVEL="INFO"
LOG_FILE=""  # set to e.g. "logs/llama3_iters_4.log" to persist logs
