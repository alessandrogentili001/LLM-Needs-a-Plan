...
if [ $RESULT -eq 0 ]; then
    ...
    echo "   Reasons:"
    echo "   - Phi4: 14B parameters vs Llama4: 107B parameters"
    echo "   - Phi4: 1 GPU vs Llama4: 4 GPUs"
    echo "   - Phi4: Reliable memory usage vs Llama4: Memory issues"
    echo "   - Phi4: Faster inference vs Llama4: Slower generation"
    echo ""
    echo "   Performance comparison studies show Phi4 often"
    echo "   matches or exceeds larger models on reasoning tasks."
fi
