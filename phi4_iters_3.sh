...
#SBATCH --mem=64G
#SBATCH --job-name=phi4_iters_3
#SBATCH --output=phi4_iters_3.out
#SBATCH --error=phi4_iters_3.err
...
# Model configuration
MODEL_NAME="phi4"
WEIGHTS_PATH="src/models/Phi4"  # weights directory for the chosen model
...
LOG_LEVEL="INFO"
LOG_FILE=""  # set to e.g. "logs/phi4_iters_1.log" to persist logs
